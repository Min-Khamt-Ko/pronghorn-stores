        ...
        <form method="POST" action="/update" enctype="multipart/form-data">
            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">product
                                photo</label>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="category" id="category" autocomplete="given-name" value="<?= $product['category'] ?>"
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-2">
                                <input id="price" name="price" type="text" autocomplete="price" value="<?= $product['price'] ?>"
                                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button type="button" class="text-sm font-semibold leading-6 text-gray-900"><a
                            href="<?= previouseUrl() ?>">Cancle</a></button>
                <button type="submit"
